<%-- 
    Document   : List_PRN211
    Created on : Dec 14, 2022, 10:37:07 PM
    Author     : asus
--%>
                    ...
                    <div class="container-fluid">
                                    ...
                                    <tbody>
                                        <c:forEach items="${list}" var="item">
                                            <tr>
                                                ...
                                                <th>PRN211</th>
                                                <th>${item. getDoKho()}</th>
                                                <td><a href="edit_PRN211?mod=0&id=${item.getMaCh()}"/>Edit</td>
                                                <td><a href="edit_PRN211?mod=1&id=${item.getMaCh()}" onclick="return confirm('Are you sure want to delete')"/>Delete</td>
                                            </tr>
                                        </c:forEach>   
                                    </tbody>
                                </table>
                        ...
                        <div class="pagination">
                         <c:forEach begin="1" end="${endPage}" var="i">
                             <a href="list_PRN211?index=${i}">${i}</a>
                        </c:forEach>
                        </div>
