<%-- 
    Document   : AddShortAnswer
    Created on : Dec 13, 2022, 6:48:19 PM
    Author     : asus
--%>
<%-- 
    ...
    <body>
        <div class="dash">
            ...
            <div class="dash-app">
                ...
                <div class="container">
                    <form action="short_answer" method="post">
                        <h1>Short Answer</h1>
                        ...
                        <select name="subject">
                            <c:forEach items="${list}" var="item">
                                <option <c:if test="${question.getMaMon() == item.getMaMon()}">
                                    selected="selected"
                                </c:if>  value="${item.getMaMon()}">${item.getMaMon()}</option>
                            </c:forEach>
                        </select>
                        <label>Độ khó</label>
                        <select name="level"> 
                        ...
                        <textarea id="message" value="${true_answer}" name="question" cols="30" rows="5" placeholder="Message">${question.getNoiDung()}</textarea>
                        <label for="gender">Answer :</label>
                        <input type="text" value="${true_answer}" name="first_answer"/>
