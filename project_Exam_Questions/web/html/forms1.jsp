<%-- 
    Document   : forms1
    Created on : Dec 8, 2022, 9:58:41 PM
    Author     : asus
--%>
        ...
        <div class="dash-app">
            ...
            <main class="dash-content">
                <div class="container-fluid">
                    <h1 class="dash-title">Multichoice One Answer</h1>
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="card spur-card">
                                <div class="card-header">
                                    ...
                                    <div class="spur-card-title">Add Question</div>
                                </div>
                                <div class="card-body ">
                                    <form>
                                        
                                        <div class="form-group">
                                            <label for="exampleFormControlSelect1">Mã Môn</label>
