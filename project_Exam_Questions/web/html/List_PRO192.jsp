<%-- 
    Document   : List_PRO192
    Created on : Dec 15, 2022, 2:17:21 AM
    Author     : asus
--%>

<%-- 
    Document   : List_PRJ301
    Created on : Dec 14, 2022, 11:21:58 PM
    Author     : asus
--%>
                    ...
                    <div class="container-fluid">
                                    ...
                                    <tbody>
                                        <c:forEach items="${list}" var="item">
                                            <tr>
                                                ...
                                                <th>PRO192</th>
                                                <th>${item. getDoKho()}</th>
                                                <td><a href="edit_PRJ301?mod=0&id=${item.getMaCh()}"/>Edit</td>
                                                <td><a href="edit_PRJ301?mod=1&id=${item.getMaCh()}" onclick="return confirm('Are you sure want to delete')"/>Delete</td>
                                            </tr>
                                        </c:forEach>   
                                    </tbody>
                                </table>
                        ...
                        <div class="pagination">
                         <c:forEach begin="1" end="${endPage}" var="i">
                             <a href="list_PRJ301?index=${i}">${i}</a>
                        </c:forEach>
                        </div>
