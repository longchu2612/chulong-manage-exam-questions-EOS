<%-- 
    Document   : Multichoice_two
    Created on : Dec 13, 2022, 6:03:10 PM
    Author     : asus
--%>
    ...
    <body>
        <div class="dash">
            ...
            <div class="dash-app">
                ...
                <div class="container">
                    <form action="add_mutichoice_two" method="post">
                        <h1>Multichoice Question(Two Answer)</h1>
                        ...
                        <select name="subject">
                            <c:forEach items="${list}" var="item">
                                <option
                                    <c:if test="${question.getMaMon() == item.getMaMon()}">
                                    selected="selected"
                                </c:if> 
                        ...
                        <label for="question">True Answer:</label>
                        <input type="text" value="${four_answer}" name="four_answer"/>
