<%-- 
    Document   : YesNoQuestion
    Created on : Dec 13, 2022, 8:04:37 PM
    Author     : asus
--%>
    ...
    <body>
        <div class="dash">
            ...
            <div class="dash-app">
                ...
                <div class="container">
                    <form action="yes_no_answer" method="post">
                        ...
                        <select name="answer">
                            <option <c:if test="${true_answer == 'Yes'}">
                                    selected="selected"
                                </c:if> value="Yes">Yes</option>
                            <option <c:if test="${true_answer == 'No'}">
                                    selected="selected"
                                </c:if> value="No">No</option>
                        </select>
